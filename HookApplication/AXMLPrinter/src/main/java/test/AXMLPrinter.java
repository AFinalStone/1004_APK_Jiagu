...
public class AXMLPrinter {
    ...
    public static StringBuilder mStringContent = new StringBuilder();
    ...
    public static void main(String[] arguments) {
        ...
        try {
            String fileInputName = arguments[0];
            String fileOutName = arguments[1];
            AXmlResourceParser parser = new AXmlResourceParser();
            parser.open(new FileInputStream(fileInputName));
            ...
            fileWriter.write(mStringContent.toString());
            fileWriter.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
